...
## ADR-014 - Postagens manuais por conta

Data: 2026-07-04

Decisao: um video e o conteudo mestre, uma Account e uma conta real em uma
plataforma, e `video_publications` registra onde aquele video foi postado.

Motivo: o mesmo video pode performar de formas diferentes em contas diferentes.

Consequencias:

- A interface nao usa o termo tecnico "Publication".
- A interface usa "Publicado em", "Onde este video foi publicado" e "Historico de postagens".
- Cada registro tem status, data, link, metricas e observacoes proprias.
- Tudo e preenchido manualmente nesta fase.
- Nao ha publicacao automatica por API.

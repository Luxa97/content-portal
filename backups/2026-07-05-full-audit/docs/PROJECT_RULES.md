...
- A lista de e-mails permitidos para novo cadastro fica em `lib/allowed-users.ts`.
- Login deve autenticar usuarios existentes pelo Supabase Auth.
- Cadastro deve validar a allowlist antes de chamar o Supabase.
- Nao permitir cadastro publico fora da allowlist.
